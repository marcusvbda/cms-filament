                    ...
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="col-12 col-md-10 text-center">
                            <h1 class="display-3 fw-bold mb-4 text-center" data-aos="fade-left">
                                {{ ucfirst(BladeTranslator::__(data_get($attributes, 'header_title'))) }}</h1>
                            <p class="fs-5 text-muted pb-5" data-aos="fade-right">
                                {{ ucfirst(BladeTranslator::__(data_get($attributes, 'header_description'))) }}</p>
                            <div class="case-card-items" data-aos="fade-up">
                                @foreach (data_get($attributes, 'cases', []) as $case)
                                    <div class="case-card">
